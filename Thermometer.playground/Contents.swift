...
class Thermometer {
    ...
    init(fahrenheit: Double, celsius: Double, description: String){
...
var thermometer = Thermometer(fahrenheit: 88.0, celsius: 0.0, description: "")
